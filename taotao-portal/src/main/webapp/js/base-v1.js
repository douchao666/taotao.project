 ...
 */
function login() {
    return location.href = "http://localhost:8083/page/showLogin";
}
function regist() {
    return location.href = "http://localhost:8083/page/register";
}
...
function search(a) {
    var b = "http://localhost/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
